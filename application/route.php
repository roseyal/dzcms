...
Route::rule('404','admin/news/img');
Route::rule('welcome','admin/aduser/welcome');
Route::rule('quit','quit/aduser/quit'); 
Route::rule('templet_page','admin/templet/templet');
//系统设置
...
Route::rule('database_backups','admin/database/db_list');  //数据库备份
Route::rule('database_restore','admin/database/db_restore_list');//数据库还原
//广告位管理
...
//新闻列表
Route::rule('listnews','/home/article/listnews');
//新闻内容
Route::rule('news','/home/article/news');
...
/*静态页面*/
Route::rule('statichtml','/admin/templet/statichtml');
Route::rule('prolist','/admin/News/prolist');  //产品列表
Route::rule('proadd','/admin/News/proadd');  //产品添加
return [
    '__pattern__' => [
        'name' => '\w+',
    ],
